// src/Componentes/Dashboard/DashboardEmpleado.tsx
// Dashboard personal para empleados (clientes) - Vista de su crédito y consumos
...
export default function DashboardEmpleadoPersonal() {
  ...
  const cargarConsumos = async () => {
    try {
      ...
      const hasta = new Date(parseInt(year), parseInt(month), 0).toISOString().split("T")[0];
    ...
    return (
      <div className="min-h-screen bg-gray-50 flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-gray-500 mb-4">No se encontró un perfil de empleado asociado a tu usuario.</p>
          <button
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <main className="max-w-3xl mx-auto px-6 py-6 space-y-6">
          ...
          {loadingConsumos ? (
            ...
            <div className="p-8 text-center">
              ...
              <p className="text-sm text-gray-500">
                No tienes consumos registrados en {getNombreMes(mesSeleccionado)}
              </p>
            </div>
          ) : (
                    ...
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        <p className="font-medium text-gray-900">
                          ...
                          {consumo.reversado && (
                            <span className="ml-2 text-xs text-red-500 font-normal">(Reversado)</span>
                          )}
                        </p>
                        <p className="text-sm text-gray-500">
        ...
        <div className="text-center text-sm text-gray-400 pb-4">
          <p>Usuario: {currentUser?.usuario}</p>
        </div>
      </main>
    </div>
  );
